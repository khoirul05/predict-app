...
@section('content')
<div class="main" style="min-height: 947px;">
			<!-- MAIN CONTENT -->
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$karyawan->getAvatar()}}" class="img-circle" alt="Avatar">
								...
								<div class="profile-detail">
									<div class="profile-info">
										<h4 class="heading">Detail Data Karyawan</h4>
										<ul class="list-unstyled list-justify">
											<li>Jenis Kelamin <span>{{$karyawan->jenis_kelamin}}</span></li>
											<li>Bidang Pekerjaan <span>{{$karyawan->bidang_pekerjaan}}</span></li>
